...
public class ProductClient extends ApiClient {
    ...
    public Account requestProductConfiguration(String id, JSONObject request) throws RazorpayException , JSONException{
        return post(Constants.VERSION_V2, String.format(Constants.PRODUCT_REQUEST_CONFIGURATION, id), request);
    }

    public Account fetch(String id, String product_id) throws RazorpayException, JSONException {
        return get(Constants.VERSION_V2, String.format(Constants.PRODUCT_CONFIGURATION, id, product_id), null);
    }

    public Account edit(String id, String product_id, JSONObject request) throws RazorpayException , JSONException{
        return patch(Constants.VERSION_V2, String.format(Constants.PRODUCT_CONFIGURATION, id, product_id), request);
    }

    public TncMap fetchTnc(String product_name) throws RazorpayException , JSONException{
