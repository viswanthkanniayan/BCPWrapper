...
public class QrCodeClient extends ApiClient {
    ...
    public QrCode create(JSONObject request) throws RazorpayException , JSONException{
        return post(Constants.VERSION, Constants.QRCODE_CREATE, request);
    }

    public QrCode fetch(String id) throws RazorpayException , JSONException{
     ...
     */
    public List<QrCode> fetchAll() throws RazorpayException , JSONException{
     ...
     * @throws RazorpayException
     */
    public List<QrCode> fetchAll(JSONObject request) throws RazorpayException, JSONException {
       return getCollection(Constants.VERSION, Constants.QRCODE_LIST, request);
    }

    public List<QrCode> fetchAllPayments(String id) throws RazorpayException , JSONException{
        return fetchAllPayments(id,null);
    }

    public List<QrCode> fetchAllPayments(String id,JSONObject request) throws RazorpayException, JSONException {
        return getCollection(Constants.VERSION, Constants.QRCODE_LIST+"/"+id+"/"+Constants.QRCODE_FETCH_PAYMENT, request);
    }
    
    public QrCode close(String id) throws RazorpayException, JSONException {
