...
public class SettlementClient extends ApiClient {
     ...
     */
    public List<Settlement> fetchAll() throws RazorpayException , JSONException{
     ...
     * @throws RazorpayException
     */
    public List<Settlement> fetchAll(JSONObject request) throws RazorpayException, JSONException {
        return getCollection(Constants.VERSION, Constants.SETTLEMENTS, request);
    }

    public Settlement fetch(String id) throws RazorpayException, JSONException {
        return get(Constants.VERSION, String.format(Constants.SETTLEMENT, id), null);
    }

    public List<Settlement> reports(JSONObject request) throws RazorpayException, JSONException {
        return getCollection(Constants.VERSION, Constants.SETTLEMENTS_REPORTS, request);
    }

    public List<Settlement> reports() throws RazorpayException, JSONException {
        return reports(null);
    }

    public Settlement create(JSONObject request) throws RazorpayException, JSONException {
     ...
     * @throws RazorpayException
     */
    public List<Settlement> fetchAllDemand() throws RazorpayException , JSONException{
     ...
     * @throws RazorpayException
     */
    public List<Settlement> fetchAllDemand(JSONObject request) throws RazorpayException, JSONException {
        return getCollection(Constants.VERSION, Constants.SETTLEMENTS_INSTANT, request);
    }

    public Settlement fetchDemandSettlement(String id) throws RazorpayException , JSONException{
