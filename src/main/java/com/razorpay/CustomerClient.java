...
public class CustomerClient extends ApiClient {
   ...
   */
  public List<Customer> fetchAll() throws RazorpayException, JSONException {
   ...
   * @throws RazorpayException
   */
  public List<Customer> fetchAll(JSONObject request) throws RazorpayException , JSONException{
  ...
  public Customer deleteToken(String id, String tokenId) throws RazorpayException , JSONException{
    return delete(Constants.VERSION, String.format(Constants.TOKEN_DELETE, id, tokenId), null);
  }

  public BankAccount addBankAccount(String id, JSONObject request) throws RazorpayException, JSONException {
    return post(Constants.VERSION, String.format(Constants.ADD_BANK_ACCOUNT, id), request);
  }

  public Customer deleteBankAccount(String id, String bankId) throws RazorpayException , JSONException{
    return delete(Constants.VERSION, String.format(Constants.DELETE_BANK_ACCOUNT, id, bankId), null);
  }

  public Customer requestEligibilityCheck(JSONObject request) throws RazorpayException, JSONException {
    return post(Constants.VERSION, Constants.ELIGIBILITY, request);
  }

  public Customer fetchEligibility(String id) throws RazorpayException, JSONException {
